 ...
 */
public class HelloAnim extends androidx.appcompat.widget.AppCompatTextView {
    ...
    public HelloAnim(Context context) {
        super(context);
        init();
    }

    public HelloAnim(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
